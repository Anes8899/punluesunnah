...
import type { AqidahLesson } from "@/lib/aqidah-data";

interface AqidahLessonCardProps {
  bookId: number;
  lesson: AqidahLesson;
}

export default function AqidahLessonCard({
  bookId,
  lesson,
}: AqidahLessonCardProps) {
  return (
    <Link
      href={`/aqidah/${bookId}/${lesson.id}`}
