import type { AqidahContentBlock, AqidahTone } from "@/lib/aqidah-data";

const TONES: Record<AqidahTone, string> = {
...
function Block({ block }: { block: AqidahContentBlock }) {
  switch (block.type) {
    case "text":
      return (
...
function Blocks({ blocks }: { blocks: AqidahContentBlock[] }) {
  return (
...
export default function AqidahLessonContent({
  content,
}: {
