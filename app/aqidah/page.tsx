...
const tawhidCategories = [
  {
    ...
    citation: "Cf. Qur'an 7:54 — \"Unquestionably, His is the creation and command.\"",
  },
  {
    ...
    citation: "Cf. Qur'an 1:5 — \"It is You we worship and You we ask for help.\"",
  },
  {
    ...
    <div className="mx-auto max-w-4xl rounded-lg bg-white px-6 py-8 shadow-sm sm:px-10">
      <header className="text-center">
        ...
        <h1 className="mt-2 text-3xl font-bold text-slate-800 sm:text-4xl">
          Aqidah: The Foundations of Islamic Belief
        </h1>
        <p className="font-arabic mt-2 text-2xl text-[#00966b]">
          العقيدة الإسلامية
        </p>
        <p className="mx-auto mt-3 max-w-xl text-sm text-slate-500">
          An overview of Tawḥīd and the Six Pillars of Īmān, with supporting
      ...
      <Accordion
        type="multiple"
        defaultValue={["what-is-aqidah", "tawhid", "pillars", "closing"]}
      >
        <AccordionItem value="returns">
          ...
          <AccordionContent>
            <p className="mt-3 leading-7 text-slate-600">
              ...
              &quot;creed&quot; or &quot;that which is firmly tied&quot;)
              denotes the body of belief a Muslim holds with certainty —
              matters of faith rather than practice. It is distinguished
              from <em>fiqh</em> (jurisprudence), which governs action;
              aqidah governs conviction. Classical scholars organized it
              around belief in Allah, His angels, His scriptures, His
              messengers, the Last Day, and divine decree (
              <em>al-qadar</em>) — collectively the Six Pillars of Īmān —
              underpinned throughout by <em>Tawḥīd</em>, the affirmation
              that Allah alone is God.
            </p>
          </AccordionContent>
        </AccordionItem>

        <AccordionItem value="tawhid" className="mt-10">
          <AccordionTrigger>
            <h2 className="text-2xl font-bold text-slate-800">
        ...
        <AccordionItem value="pillars" className="mt-10">
          <AccordionTrigger>
            <h2 className="text-2xl font-bold text-slate-800">
        ...
        <AccordionItem value="closing" className="mt-10">
          <AccordionTrigger>
            <h2 className="text-2xl font-bold text-slate-800">
