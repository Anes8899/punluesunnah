    ...
    <div className="mx-auto max-w-4xl rounded-lg bg-white px-6 py-8 shadow-sm sm:px-10">
      ...
      <section>
        ...
        <p className="mt-3 leading-7 text-slate-600">
          ...
          <span className="italic text-slate-500">al-ʿaqīdah</span>, &quot;creed&quot;
          or &quot;that which is firmly tied&quot;) denotes the body of belief a
          Muslim holds with certainty — matters of faith rather than
          practice. It is distinguished from <em>fiqh</em> (jurisprudence),
          which governs action; aqidah governs conviction. Classical scholars
          organized it around belief in Allah, His angels, His scriptures,
          His messengers, the Last Day, and divine decree (<em>al-qadar</em>)
          — collectively the Six Pillars of Īmān — underpinned throughout by{" "}
          <em>Tawḥīd</em>, the affirmation that Allah alone is God.
        </p>
      </section>
