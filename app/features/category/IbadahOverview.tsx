...
export default function IbadahOverview() {
  return (
    <div className="overflow-hidden rounded-lg bg-surface-soft text-[#201e1d]">
      <div className="mx-auto max-w-[900px] px-5 pb-16 sm:px-10 sm:pb-20 lg:px-14 lg:pb-24">
        ...
        <section className="border-t border-[#201e1d]/16 py-8 sm:py-12 lg:py-14">
          ...
          <div className="flex flex-col items-start gap-4">
            <div className="font-quran text-right text-3xl leading-[1.9] sm:text-4xl">
              وَمَا خَلَ<span style={{ color: TAJWEED.qalqalah }}>قْ</span>تُ
              الْ
              <span style={{ color: TAJWEED.ghunnah }}>جِنَّ</span> وَالْإِنسَ
              إِلَّا لِيَعْبُ
              <span style={{ color: TAJWEED.madd }}>دُو</span>نِ
            </div>
            <div>
              <p className="m-0 mb-2 text-[17px] leading-[1.8] text-[#201e1d]/80 italic">
                «ហើយយើងមិនបានបង្កើតជិន និងមនុស្សលោក
                ក្រៅពីឲ្យពួកគេគោរពសក្ការៈយើងឡើយ»
              </p>
              <p className="m-0 text-[11px] text-[#201e1d]/55">
                សូរ៉ោះអាហ្ស៊្ហារីយ៉ាត ៥១:៥៦
              </p>
            </div>
          </div>
              ...
              return (
                <Fragment key={c.ar}>
                  ...
                  >
                    ...
                    <div className={`font-quran text-3xl font-bold ${tc.text}`}>
                      {c.ar}
                    </div>
        ...
        <section className="border-t border-[#201e1d]/16 py-8 sm:py-12 lg:py-14">
          ...
          <div className="rounded-[16px] bg-[#ebddc5] p-6 shadow-[0_3px_10px_rgba(46,43,37,0.16)]">
            <div className="font-quran mb-4 text-center text-2xl leading-[1.9] sm:text-3xl">
              فَاذْكُرُونِي أَ
              <span style={{ color: TAJWEED.ghunnah }}>ذْكُرْكُمْ</span>{" "}
              وَاشْكُرُوا لِي وَلَا تَكْفُ
              <span style={{ color: TAJWEED.madd }}>رُو</span>نِ
            </div>
          ...
          <div className="flex flex-col gap-4">
            {CONDITIONS.map((c) => {
              ...
              return (
                ...
                >
                  <div
                    className={`font-quran min-w-[100px] flex-none text-center text-3xl font-bold ${tc.text}`}
                  >
                    {c.ar}
                  </div>
                  <div>
                    ...
                    <p className="m-0 text-[13.5px] leading-[1.7] opacity-[0.82]">
                      {c.body}
                    </p>
                  </div>
                </div>
        ...
        <section className="border-t border-[#201e1d]/16 pt-10 text-center sm:pt-14 lg:pt-16">
          <h3 className="mb-2 text-xl font-bold sm:text-2xl">
            បន្តការសិក្សា និងគោរពប្រណិប័តន៍
          </h3>
